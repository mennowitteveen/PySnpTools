#cmk delete
##from pysnptools.util.mapreduce1.runner import Runner,_JustCheckExists,_shape_to_desired_workcount
#import os, sys
#import logging
...
#            shaped_distributable = _shape_to_desired_workcount(distributable, count)
